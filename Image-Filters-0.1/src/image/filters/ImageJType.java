 ...
 */
@TypeInfo(type = Image.class, input = true, output = true, style = "imageJType")
public class ImageJType extends TypeRepresentationBase
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1
                    ...
                    if (plotPane.getImage() != null || isInput()) {
                        imagePlus = new ImagePlus("image", (Image) getViewValue());
                        imageJ = new ImageJ();
                        ...
                        iw.addWindowListener(new WindowAdapter() {
                            ...
                            public void windowClosing(WindowEvent e) { //windowClosing
                                ...
                                setViewValue(iw.getImagePlus().getImage());
                                imageJ.quit();
                                iw.close();
                                if(iw.isVisible()==false){
